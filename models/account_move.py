...
class AccountInvoiceElectronicOtros(models.Model):
    _name = "account.move.otros"

    name = fields.Char(string="Nombre", copy=False)
    valor = fields.Char(string="Valor", copy=False)
...
class AccountInvoiceElectronic(models.Model):
    ...
    otros = fields.Many2many("account.move.otros",string="Referencias electrónicas", required = False)
    indicar_otros = fields.Boolean(default=False, string="Indicar Referencias", required = False)
    fecha_otros = fields.Boolean(default=False, string="Incluir Fecha", required=False)
